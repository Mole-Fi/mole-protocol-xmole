...
contract TaxFeeder is Initializable, OwnableUpgradeable {
  ...
  function feed() external {
    ...
    // transfer reward to mole feeder
    token.safeTransfer(moleFeeder, _feedAmount);

    emit LogFeed(moleFeeder, _feedAmount);
